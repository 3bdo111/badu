...
const DEFAULT_SOCIAL_LINKS: SocialLink[] = [
  {
    ...
    platform: "instagram",
    label: "Instagram",
    url: "https://www.instagram.com/badu_hoodie?stkn=a3RycWdocjB4YzU0",
    icon: "instagram",
    sortOrder: 0,
    visible: true,
  },
  {
    ...
    platform: "tiktok",
    label: "TikTok",
    url: "https://www.tiktok.com/@z25662?_r=1&_t=ZS-99XBSM5c8Ky",
    icon: "tiktok",
    sortOrder: 1,
    visible: true,
  },
  {
    ...
    platform: "facebook",
    label: "Facebook",
    url: "https://www.facebook.com/share/1DU4rE5HDG/?mibextid=wwXIfr",
    icon: "facebook",
    sortOrder: 2,
    visible: true,
  },
